  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem
        ...
        className={cn(
          "bg-background/40 dark:bg-background/50 fixed right-4 bottom-12 left-4 z-20 flex max-w-full min-w-xs flex-col rounded-lg px-4 py-1 shadow-xl backdrop-blur-md sm:right-[unset] sm:left-6 sm:w-xs sm:max-w-xs sm:shadow-lg md:bottom-6",
        )}
      >
        ...
        <AccordionContent className="bg-accent my-1 mb-2 overflow-hidden rounded-lg px-3 pb-0">
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger>Schrony</AccordionTrigger>
              <AccordionContent className="flex flex-col gap-4 text-balance">
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-green-600 bg-green-100/50 backdrop-blur-md">
                ...
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-blue-600 bg-blue-100/50 backdrop-blur-md">
                    <Warehouse className="size-3 text-blue-500" />
                  </div>
                  <p className="text-xs"> - U (ukrycie)</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-rose-600 bg-rose-100/50 backdrop-blur-md">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="flex flex-col gap-4 text-balance">
                ...
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-yellow-600 bg-yellow-100/50 backdrop-blur-md">
                    <Wind className="size-3 text-yellow-500" />
                  </div>
                  <p className="text-xs"> - Dobra</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-orange-600 bg-orange-100/50 backdrop-blur-md">
                    <Wind className="size-3 text-orange-500" />
                  </div>
                  <p className="text-xs"> - Umiarkowana</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-red-600 bg-red-100/50 backdrop-blur-md">
                    <Wind className="size-3 text-red-500" />
                  </div>
                  <p className="text-xs"> - Dostateczna</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-purple-600 bg-purple-100/50 backdrop-blur-md">
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="flex flex-col gap-4 text-balance">
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-blue-400 bg-blue-100/50 backdrop-blur-md">
                ...
                <div className="flex items-center gap-1">
                  <div className="dark:bg-background/30 flex size-5 items-center justify-center rounded-full border border-blue-800 bg-blue-100/50 backdrop-blur-md">
